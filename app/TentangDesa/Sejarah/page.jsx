      ...
      <div className="mt-24 pb-8 lg:mt-40 container mx-auto px-3 sm:px-4 lg:px-10 text-justify">
        ...
        <div className="mt-6 sm:mt-8 text-gray-600 text-sm sm:text-base">
          <p className="text-center italic">
            ...
            ini adalah sebuah hutan lebat nan sunyi yang dikenal sebagai Alas
            Jerem. Sebuah tempat yang diselimuti misteri, konon dikuasai oleh
            roh perkasa bernama Buta Siyu. Dari hutan inilah, sebuah kisah epik
            tentang penciptaan, pengorbanan, dan penjagaan keseimbangan jagat
            dimulai.
          </p>
        </div>
        <div>
          <section>
            <div className="mt-12 sm:mt-20 text-gray-600 text-sm sm:text-base">
              ...
              <p className="mt-3 sm:mt-4">
                ...
                Melihat penderitaan ini, Ida Hyang Pasupati, yang bersthana di
                Gunung Semeru, tergerak untuk turun ke Bali. Pada hari suci{" "}
                <strong>Buda Kliwon Shinta</strong> , Beliau tiba di Alas Jerem
                bersama jutaan dewa. Di sanalah mereka menggelar sebuah paruman
                agung (pertemuan suci) untuk menyusun strategi melawan kekuatan
              ...
              <p className="mt-3 sm:mt-4">
                ...
                biasa. I Kala Sunya pun menyerah dan memohon ampun. Ia berjanji
                tidak akan lagi mengganggu Bali, asalkan setiap tahun pada bulan
                Caitra, sebuah persembahan suci bernama Tawur Amanca Wali Krama
                dipersembahkan untuknya. Di tempat paruman agung itulah, sebuah
                Kahyangan (tempat suci) didirikan dan diberi nama{" "}
                <strong>Kahyangan Puseh Payogan Agung</strong>. Sejak saat itu,
                tempat ini menjadi pusat spiritual untuk memulihkan dan menjaga
                harmoni jagat Bali.
              </p>
            </div>
          </section>
          ...
          <section>
            <div className="mt-10 sm:mt-14 text-gray-600 text-sm sm:text-base">
              ...
              <p className="mt-3 sm:mt-4">
                ...
                di Pura Pasar Agung Besakih. Setelah melakukan perjalanan
                spiritual yang panjang, ia menerima pawisik (bisikan gaib) dari
                Ida Hyang Pasupati untuk menuju Alas Jerem. Di sana, ia diangkat
                menjadi Pemongmong Widhi (penjaga spiritual) pertama. Statusnya
              ...
              <p className="mt-3 sm:mt-4">
                ...
                Gelgel menolak. Benar saja, dalam perjalanan pulang, badai
                dahsyat menewaskan 200 pengikutnya. Murka dan salah paham, Dalem
                Gelgel menuduh Dukuh Murti sebagai penyebabnya, lalu
                memerintahkan utusannya untuk membunuh sang penjaga suci dan
                istrinya. Tragedi ini melahirkan sebuah kutukan: keturunan sang
                utusan selamanya dilarang memimpin upacara di Pura Payogan
                Agung.
              </p>
            </div>
          </section>
          ...
          <section>
            <div className="mt-10 sm:mt-14 text-gray-600 text-sm sm:text-base">
              ...
              <p className="mt-3 sm:mt-4">
                ...
                ajaib inilah, wilayah Alas Jerem secara resmi dinamai Desa
                Ketewel.
              </p>
            </div>
          </section>
          ...
          <section>
            <div className="mt-10 sm:mt-14 text-gray-600 text-sm sm:text-base">
              ...
              <p className="mt-3 sm:mt-4">
                ...
                memerintah. Karena baktinya yang tulus, ia mendapat petunjuk
                suci untuk membangun sebuah Meru tumpang sembilan sebagai sthana
                Ida Bhatara Hyang Giri Jagat Natha, dan Meru tumpang lima untuk
              ...
              <p className="mt-3 sm:mt-4">
                ...
                saat Ida Dewa Agung Anom Karna dari Puri Sukawati berkuasa.
                Beliau membangun kembali meru-meru yang runtuh dan menggelar
                upacara agung Panca Walikrama, membawa kembali era kedamaian
                yang dikenang dengan ungkapan "tan hana wong mati lare" (tidak
                ada anak-anak yang meninggal dunia).
              </p>
            </div>
          </section>
            ...
            <div className="mt-10 sm:mt-14 text-gray-600 text-sm sm:text-base">
              ...
              <div className="mt-3 sm:mt-4 text-gray-600">
                ...
                <p className="mt-2 text-sm sm:text-base">
                  ...
                  selama 42 hari, lalu dikirim ke Payogan Agung. Tarian ini
                  hanya dibawakan oleh gadis-gadis yang belum akil balig dan
              ...
              <div className="mt-3 sm:mt-4 text-gray-600">
                ...
                <p className="mt-2 text-sm sm:text-base">
                  ...
                  Mapedudusan Agung oleh penari yang telah disucikan (mewinten)
                  sebagai penutup dan penyempurna upacara (pemuwus karya).
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <div className="mt-10 sm:mt-14 text-gray-600 text-sm sm:text-base">
              ...
              <p className="mt-3 sm:mt-4">
                ...
                ditemukan berbagai peninggalan dari Masa Sejarah Bali Kuno,
                termasuk: Lingga Yoni: Simbol Siwa-Sakti yang menjadi pusat
                pemujaan kuno. Arca-arca Kuno: Berbagai patung perwujudan dewa
                dan tokoh suci, beberapa dalam bentuk fragmen yang menunjukkan
                usianya yang sangat tua. Prasasti Batu: Lempengan batu dengan
                tulisan kuno yang menjadi bukti sejarah. Arca Gajah dan Ukiran
                Kebo Iwa: Patung-patung monumental yang dihormati oleh
                masyarakat setempat. Penemuan ini membuktikan bahwa Ketewel
                telah menjadi pusat spiritual penting selama berabad-abad.
              </p>
            </div>
          </section>
        </div>
